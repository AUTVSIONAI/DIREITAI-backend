-- =====================================================
-- SQL CORRIGIDO PARA TABELAS DE NOTIFICAÇÕES E CAMPANHAS
-- =====================================================
...
DROP POLICY IF EXISTS "Users can view their own queue items" ON notification_queue;
...
DROP POLICY IF EXISTS "Admins can view campaign stats" ON email_campaign_stats;
DROP POLICY IF EXISTS "System can insert campaign stats" ON email_campaign_stats;
DROP POLICY IF EXISTS "Users can manage their own dismissals" ON announcement_dismissals;
